...
class TestingConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = (
        f"postgresql+psycopg2://{os.environ.get('TEST_DATABASE_USER')}:"
        f"{os.environ.get('TEST_DATABASE_PASSWORD')}@{os.environ.get('TEST_DATABASE_HOST')}:"
        f"{os.environ.get('TEST_DATABASE_PORT')}/{os.environ.get('TEST_DATABASE_NAME')}"
    )
